...
namespace Ravuno.DataStorage.Migrations
{
    ...
    public partial class RenameSqlScriptToQuery : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameTable(name: "SqlScripts", newName: "Queries");

            // Rename the Query column to SqlQuery
            migrationBuilder.RenameColumn(name: "Query", table: "Queries", newName: "SqlQuery");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(name: "SqlQuery", table: "Queries", newName: "Query");

            migrationBuilder.RenameTable(name: "Queries", newName: "SqlScripts");
        }
    }
}
